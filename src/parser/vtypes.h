...
class VTypes
{
	public:
	// Data Types
	enum DataType { NoData, IntegerData, DoubleData, StringData, VectorData, AtenData, AtomData, BondData, CellData, ElementData, ForcefieldData, ForcefieldAtomData, ForcefieldBoundData, GlyphData, GridData, MeasurementData, ModelData, PatternData, PatternBoundData, PreferencesData, nDataTypes };
