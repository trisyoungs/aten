...
class VTypes
{
	public:
	// Data Types
	enum DataType { NoData, IntegerData, DoubleData, StringData, VectorData, AtenData, AtomData, BasisPrimitiveData, BasisShellData, BondData, CellData, EigenvectorData, ElementData, ForcefieldData, ForcefieldAtomData, ForcefieldBoundData, GlyphData, GlyphDataData, GridData, MeasurementData, ModelData, PatternData, PatternBoundData, PreferencesData, RegionData, VibrationData, ZMatrixData, ZMatrixElementData, nDataTypes };
