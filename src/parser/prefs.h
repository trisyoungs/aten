...
class PreferencesVariable : public Variable
{
	...
	*/
	public:
	// Accessor list
	enum Accessors { AngleLabel, AtomDetail, AtomStyleRadius, BackCull, BackgroundColour, BondDetail, BondStyleRadius, BondTolerance, CacheLimit, CalculateElec, CalculateIntra, CalculateVdw, ClipFar, ClipNear, ColourScheme, CombinationRule, CommonElements, DensityUnit, DepthCue, DepthFar, DepthNear, DistanceLabel, ElecCutoff, ElecMethod, EnergyUnit, EnergyUpdate, EwaldAlpha, EwaldKMax, EwaldPrecision, ForceRhombohedral, ForegroundColour, GlobeSize, GlyphColour, HDistance, KeyAction, LabelSize, LineAliasing, ManualSwapBuffers, MaxCuboids, MaxRings, MaxRingSize, MaxUndo, ModelUpdate, MouseAction, MultiSampling, OffScreenObjects, Perspective, PerspectiveFov, PolygonAliasing, RenderStyle, ReplicateFold, ReplicateTrim, ScreenObjects, SelectionScale, Shininess, SpecularColour, Spotlight, SpotlightAmbient, SpotlightDiffuse, SpotlightPosition, SpotlightSpecular, UseFrameBuffer, UseNiceText, VdwCutoff, VdwScale, Warn1056, ZMapping, ZoomThrottle, nAccessors };
	// Function list
