...
class PreferencesVariable : public Variable
{
	...
	public:
	// Accessor list
	enum Accessors { AllowDialogs, AngleLabelFormat, AromaticRingColour, AtomStyleRadius, BackCull, BackgroundColour, BondStyleRadius, BondTolerance, CalculateIntra, CalculateVdw, ChargeLabelFormat, ClipFar, ClipNear, ColourScales, ColourScheme, CombinationRule, CorrectTransparentGrids, DashedAromatics, DensityUnit, DepthCue, DepthFar, DepthNear, DistanceLabelFormat, DynamicPanels, ElecCutoff, ElecMethod, EnergyUnit, EwaldAlpha, EwaldKMax, EwaldPrecision, FontFileName, ForegroundColour, GlobeSize, GlyphDefaultColour, HBonds, HBondDotRadius, HDistance, ImageQuality, KeyAction, LabelSize, LineAliasing, MaxCuboids, MaxRings, MaxRingSize, MaxUndo, MessagesFontSize, MopacExe, MouseAction, MouseMoveFilter, MultiSampling, NoQtSettings, PartitionGrid, Perspective, PerspectiveFov, PolygonAliasing, Quality, RenderStyle, ReuseQuality, SelectionScale, Shininess, SpecularColour, Spotlight, SpotlightAmbient, SpotlightDiffuse, SpotlightPosition, SpotlightSpecular, StickNormalWidth, StickSelectedWidth, TempDir, UseWidgetForegroundBackground, VdwCutoff, VibrationArrowColour, ViewerFontFileName, ViewLock, ViewRotationGlobe, ZoomThrottle, nAccessors };
	// Function list
