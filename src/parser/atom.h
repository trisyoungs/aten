...
class AtomVariable : public PointerVariable
{
	...
	*/
	public:
	// Accessor list
        enum Accessors { Bonds, Colour, F, Fixed, FracX, FracY, FracZ, FX, FY, FZ, Hidden, Id, Mass, Name, NBonds, Q, R, RX, RY, RZ, Selected, Style, Symbol, Type, V, VX, VY, VZ, Z, nAccessors };
	// Function list
