...
#ifndef ATEN_COLOURSCALEPOINTVARIABLE_H
#define ATEN_COLOURSCALEPOINTVARIABLE_H
...
class ColourScalePointVariable : public PointerVariable
{
	public:
...
// ColourScalePoint Array Variable
class ColourScalePointArrayVariable : public PointerArrayVariable
{
	public:
	// Constructor / Destructor
