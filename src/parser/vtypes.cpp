...
// Variable Types
const char *DataTypeNames[VTypes::nDataTypes] = { "no data", "int", "double", "string", "vector", "aten&", "atom&", "basisprimitive&", "basisshell&", "bond&", "unitcell&", "colourscale&", "colourscalepoint&", "eigenvector&", "element&", "energystore&", "forcefield&", "ffatom&", "ffbound&", "glyph&", "glyphdata&", "grid&", "measurement&", "model&", "pattern&", "bound&", "prefs&", "region&", "site&", "vibration&", "zmatrix&", "zmatrixelement&" };
...
const char *DataTypeKeywords[VTypes::nDataTypes] = { "_NODATA", "int", "double", "string", "vector", "_ATEN", "atom", "basisprimitive", "basisshell", "bond", "unitcell", "colourscale", "colourscalepoint", "eigenvector", "element", "energystore", "forcefield", "ffatom", "ffbound", "glyph", "_GLYPHDATA", "grid", "measurement", "model", "pattern", "bound", "_PREFS", "region", "site", "vibration", "zmatrix", "zmatrixelement" };
