...
// Variable Types
const char *DataTypeNames[VTypes::nDataTypes] = { "no data", "int", "double", "string", "vector", "aten&", "atom&", "basisfunction&", "bond&", "unitcell&", "eigenvector&", "element&", "forcefield&", "ffatom&", "ffbound&", "glyph&", "glyphdata&", "grid&", "measurement&", "model&", "pattern&", "bound&", "prefs&", "region&", "zmatrix&", "zmatrixelement&" };
const char *DataTypePhrases[VTypes::nDataTypes] = { "no data", "an integer", "a double", "a string", "a vector", "aten&", "an atom&", "a basisfunction&", "a bond&", "a unitcell&", "an eigenvector&", "an element&", "a forcefield&", "a ffatom&", "a ffbound&", "a glyph&", "a glyphdata&", "a grid&", "a measurement&", "a model&", "a pattern&", "a bound&", "some prefs&", "a region", "a zmatrix", "a zmatrix element" };
const char *DataTypeArrayPhrases[VTypes::nDataTypes] = { "no data", "an integer array", "a double array", "a string array", "a vector array", "an aten& array", "an atom& array", "a basisfunction& array", "a bond& array", "a unitcell& array", "an eigenvector& array", "an element& array", "a forcefield& array", "a ffatom& array", "a ffbound& array", "a glyph& array", "a glyphdata& array", "a grid& array", "a measurement& array", "a model& array", "a pattern& array", "a bound& array", "a prefs& array", "a region& array", "a zmatrix& array", "a zmatrixelement& array" };
const char *DataTypeKeywords[VTypes::nDataTypes] = { "_NODATA", "int", "double", "string", "vector", "_ATEN", "atom", "basisfunction", "bond", "unitcell", "eigenvector", "element", "forcefield", "ffatom", "ffbound", "glyph", "_GLYPHDATA", "grid", "measurement", "model", "pattern", "bound", "_PREFS", "region", "zmatrix", "zmatrixelement" };
