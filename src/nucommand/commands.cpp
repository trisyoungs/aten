...
CommandData Command::data[Command::nCommands] = {
	...
	{ "bondtolerance",	"n",		"<tolerance>", VTypes::NoData,
	...
	{ "newbondid",		"AAs",		"<id1> <id2> [bondtype]", VTypes::NoData,
	...
	{ "currentmodel",	"m",		"[model]", VTypes::StringData,
	...
	{ "loadmodel",		"Cc",		"<filename> [name]", VTypes::ModelData,
	...
	{ "expand",		"",		"", VTypes::NoData,
				"Expands the current atom selection" },
	{ "invert",		"",		"", VTypes::NoData,
	...
	{ "selectfftype",	"C",		"<typename>", VTypes::NoData,
