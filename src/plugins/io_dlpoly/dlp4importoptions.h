...
#include "plugins/io_dlpoly/ui_dlp4importoptions.h"
...
// DL_POLY_4 Import Options Dialog
class DLP4ImportOptionsDialog : public QDialog
{
	...
	public:
	// Constructor
	DLP4ImportOptionsDialog(KVMap& pluginOptions);

	private:
	// Main form declaration
	Ui::DLP4ImportOptionsDialog ui;
