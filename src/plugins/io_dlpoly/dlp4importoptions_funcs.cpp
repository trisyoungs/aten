...
// Constructor
DLP4ImportOptionsDialog::DLP4ImportOptionsDialog(KVMap& pluginOptions) : QDialog(NULL), pluginOptions_(pluginOptions)
{
	ui.setupUi(this);
}
...
void DLP4ImportOptionsDialog::on_CancelButton_clicked(bool checked)
{
	// Don't modify the stored pluginOptions_, just reject() the dialog
	reject(); 
}

void DLP4ImportOptionsDialog::on_OKButton_clicked(bool checked)
{
...
int DLP4ImportOptionsDialog::updateAndExecute()
{
