...
C     **********
  ...
  240 PN2 = PN2+P(I)**2
      IF(PN.LT.1.D-20) THEN
         WRITE(WU,'('' SYSTEM DOES NOT APPEAR TO BE OPTIMIZABLE.'',/
...
C#      WRITE(WU,730) SSQ
  ...
  590 CONTINUE
      ...
      TLEFT=TLEFT-TCYCLE
      IF(RESFIL)THEN
         WRITE(WU,600)TLEFT,SQRT(SSQ),ESCF
  600    FORMAT('  RESTART FILE WRITTEN,  TIME LEFT:',F9.1,
     1' GRAD.:',F10.3,' HEAT:',G14.7)
         RESFIL=.FALSE.
      ELSE
         IF(MINPRT) WRITE(WU,610)ICYC,MIN(TCYCLE,9999.99D0),
  ...
  640 XLAST(I)=X(I)
      ...
      IFLEPO=-1
      RETURN
  650 WRITE(WU,760)  NCOUNT
      GOTO 870
  660 WRITE(WU,770)  NCOUNT
      GOTO 870
  670 CONTINUE
      WRITE(WU,680) IXSO
