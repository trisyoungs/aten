...
// Constructor
MOPAC71ControlExportOptionsDialog::MOPAC71ControlExportOptionsDialog(KVMap& pluginOptions) : QDialog(NULL), pluginOptions_(pluginOptions)
{
	ui.setupUi(this);
}
...
void MOPAC71ControlExportOptionsDialog::on_CancelButton_clicked(bool checked)
{
	// Don't modify the stored pluginOptions_, just reject() the dialog
	reject(); 
}

void MOPAC71ControlExportOptionsDialog::on_OKButton_clicked(bool checked)
{
...
int MOPAC71ControlExportOptionsDialog::updateAndExecute()
{
