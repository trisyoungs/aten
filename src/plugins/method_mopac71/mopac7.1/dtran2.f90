...
!-----------------------------------------------
      ...
      real(double) :: pi, tol, s12, s3, one, r1, r2, r3, check, arg, b, sina, g&
        , a, e1, x1, e2, e3, e4, x2, x3, x4, ta, tg 
      logical :: right 

      save pi, tol, s12, s3, one 
!-----------------------------------------------
!
!  3.464... =SQRT(12)
!
      data pi, tol, s12/ 3.14159265358979D0, 0.001D0, 3.46410161513D0/  
      ...
      t(4,2,ioper) = (-(e4 - 3.D0*e2*x2)*sin(a + g)) - (3.D0*e2*x2 - x4)*sin(a&
         - g) 
