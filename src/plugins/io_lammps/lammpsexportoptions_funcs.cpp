/*
	*** LAMMPS Export Options Functions
	*** src/gui/io_lammps/lammpsexportoptions_funcs.cpp
...
// Constructor
LAMMPSExportOptionsDialog::LAMMPSExportOptionsDialog(KVMap& pluginOptions) : QDialog(NULL), pluginOptions_(pluginOptions)
{
	ui.setupUi(this);
}
...
void LAMMPSExportOptionsDialog::on_CancelButton_clicked(bool checked)
{
	// Don't modify the stored pluginOptions_, just reject() the dialog
	reject(); 
}

void LAMMPSExportOptionsDialog::on_OKButton_clicked(bool checked)
{
...
int LAMMPSExportOptionsDialog::updateAndExecute()
{
