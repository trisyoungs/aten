/*
	*** XYZ Export Options Functions
	*** src/gui/io_xyz/xyzexportoptions_funcs.cpp
...
// Constructor
XYZExportOptionsDialog::XYZExportOptionsDialog(KVMap& pluginOptions) : QDialog(NULL), pluginOptions_(pluginOptions)
{
	ui.setupUi(this);
}
...
void XYZExportOptionsDialog::on_CancelButton_clicked(bool checked)
{
	// Don't modify the stored pluginOptions_, just reject() the dialog
	reject(); 
}

void XYZExportOptionsDialog::on_OKButton_clicked(bool checked)
{
...
int XYZExportOptionsDialog::updateAndExecute()
{
