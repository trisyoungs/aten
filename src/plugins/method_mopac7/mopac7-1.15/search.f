...
C
   ...
   10 XREF(I)  =XPARAM(I)
      ...
      IF(DEBUG) THEN
         WRITE(WU,'('' SEARCH DIRECTION VECTOR'')')
         WRITE(WU,'(6F12.6)')(SIG(I),I=1,NVAR)
         WRITE(WU,'('' INITIAL GRADIENT VECTOR'')')
         WRITE(WU,'(6F12.6)')(GMIN1(I),I=1,NVAR)
      ENDIF
      GB=DOT(GMIN1,GREF,NVAR)
      IF(DEBUG) WRITE(WU,'('' GRADIENT AT START OF SEARCH:'',F16.6)')
     1SQRT(GB)
      GSTORE=GB
      AMIN=0.D0
      GMINN=1.D9
...
C
      ...
      IF( .NOT. NOPR)
     1WRITE(WU,'('' LOOKS'',I3,'' ALPHA ='',F12.6,'' GRADIENT'',F12.3,
     2'' G  ='',F16.6)')
...
C
         ...
         ENDIF
      ELSE
C#         WRITE(WU,'(//10X,'' FAILED IN SEARCH, SEARCH CONTINUING'')')
         GOTO 80
      ENDIF
   80 CONTINUE  
   ...
   90 XPARAM(I)=XMIN1(I)
      IF(DEBUG) THEN
         WRITE(WU,'('' AT EXIT FROM SEARCH'')')
         WRITE(WU,'('' XPARAM'',6F12.6)')(XPARAM(I),I=1,NVAR)
         WRITE(WU,'('' GNEXT1'',6F12.6)')(GNEXT1(I),I=1,NVAR)
         WRITE(WU,'('' GMIN1 '',6F12.6)')(GMIN1(I),I=1,NVAR)
         WRITE(WU,'('' AMIN, ANEXT,GMIN'',4F12.6)')
     1    AMIN,ANEXT,GMIN
      ENDIF
