...
CommandData Command::data[Command::CA_NITEMS] = {
	...
	{ "getgrid",		"Ev",		"<id> [variable]",
				"Retrieve grid with id specified, making it current (and placing in variable supplied)" },
	{ "gridalpha",		"E",		"<alpha>",
	...
	{ "gridvisible",	"N",		"yes|no",
				"Set the visibility of the current surface" },
	{ "loadgrid",		"N",		"<gridfile>",
				"Load grid data" },
	{ "newgrid",		"N",		"<title>",
	...
	{ "axisrotate",		"EEEeeee",	"<ax> <ay> <ax> <theta> [ox oy oz] | <i> <j> <theta> [ox oy oz]",
	...
	{ "matrixconvert",	"EEEEEEEEEEEEeeeeeeeee","<i_sx> <j_sx> <i_sy> <j_sy> <i_sz> <j_sz> <i_dx> <j_dx> <i_dy> <j_dy> <i_dz> <j_dz> [ox oy oz] | <sax> <say> <saz> <sbx> <sby> <sbz> <scx> <scy> <scz> <dax> <day> <daz> <dbx> <dby> <dbz> <dcx> <dcy> <dcz> [ox oy oz]",
				"Transform selected atoms in reference frame specified to destination frame specified" },
	{ "matrixtransform",	"EEEEEEEEEeee",	"<ax> <ay> <az> <bx> <by> <bz> <cx> <cy> <cz> [ox oy oz]",
