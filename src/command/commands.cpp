...
CommandData Commands::data_[Commands::nCommands] = {
	...
	{ "reMap",		"C",		VTypes::NoData,
		"string zMapStyle",
		"Re-map the elements of the selected atoms using the supplied z-mapping style" },
	...
	{ "deSelectF",		"Cz*",		VTypes::IntegerData,
		"string format ...",
		"Deselect specific atoms / ranges in the current model using a printf-style formatted string" },
	{ "deSelectName",	"C",		VTypes::IntegerData,
		"string name",
		"Deselect atoms whose assigned type names match the string provided" },
	...
	{ "selectName",		"C",		VTypes::IntegerData,
		"string name",
		"Select atoms whose assigned type names match the string provided" },
