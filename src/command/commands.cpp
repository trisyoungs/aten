...
CommandData Command::data[Command::nCommands] = {
	...
	{ "newatom",		"E[nnn]",	VTypes::AtomData,
		"element el, double x = 0.0, double y = 0.0, double z = 0.0",
		"Create a new atom in the current model" },
	{ "newatomfrac",	"ENNN",		VTypes::AtomData,
		"element el, double fx, double fy, double fz",
	...
	{ "scaleinterpolate",	"NB",		VTypes::StringData,
		"int scaleid, bool interpolate",
		"Set whether colour it interpolated between points in the colourscale specified" },
	{ "scalename",		"Nc",		VTypes::StringData,
		"int scaleid, string name = <not set>",
	...
	{ "for",		"_",		VTypes::NoData,
		"string expression; increment; termination condition",
		"" },
	{ "if",			"_",		VTypes::NoData, "",
	...
	{ "typedef",		"NCECc", VTypes::NoData,
		"int typeid, string name, element el, string neta, string description = <empty>",
	...
	{ "loadmodel",		"Cc",		VTypes::IntegerData,
		"string filename, string name = <not set>",
	...
	{ "setview",		"NNNNNNNNNNNNn",VTypes::NoData,
		"double ax, double ay, double az, double bx, double by, double bz, double cx, double cy, double cz, double camx, double camyu, double camz, double zrot = <not set>",
