...
CommandData Command::data[Command::nCommands] = {
	...
	{ "lookat",	"NNNNNNnnn",		VTypes::NoData,
		"double camx, double camy, double camz, double x, double y, double z, double upx = 0.0, double upy = 1.0, double upz = 0.0",
		"Set the camera position, focal target, and (optionally) the up vector (mimics GL's gluLookAt)" },
	...
	{ "translateview",	"NN",		VTypes::NoData,
		"double dx, double dy",
	...
	{ "zoomview",		"N",		VTypes::NoData,
		"double dz",
		"Zoom the camera in (dz < 0.0) or out (dz > 0.0)" },
