...
restraint_ij *restraints::does_ij_exist(Reflist<Atom,int>& rl)
{
	...
	Messenger::enter("restraints::does_lj_exist");
	...
	Messenger::exit("restraints::does_lj_exist");
	return result;
}
...
{
	Messenger::enter("restraints::clear_all");
	ijs.clear();
	Messenger::exit("restraints::clear_all");
}
...
void restraints::prune_atom(Atom* xatom)
{
	...
	Messenger::enter("restraints::prune_atom");
	...
	*/
	Messenger::exit("restraints::prune_atom");
}
