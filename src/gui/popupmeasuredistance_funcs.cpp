...
// Constructor
MeasureDistancePopup::MeasureDistancePopup(AtenWindow& parent, TMenuButton* buttonParent) : TPopupWidget(buttonParent), parent_(parent)
{
	// Set up interface
	ui.setupUi(this);
}
...
void MeasureDistancePopup::on_SelectionButton_clicked(bool checked)
{
	...
	// Hide popup
	done(false, UserAction::MeasureDistanceAction);
}
