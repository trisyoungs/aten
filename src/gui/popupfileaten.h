...
#ifndef ATEN_HOMEFILEATEN_H
#define ATEN_HOMEFILEATEN_H

#include "gui/ui_popupfileaten.h"
...
// Popup Widget - Aten
class FileAtenPopup : public TMenuButtonPopupWidget
{
	...
	FileAtenPopup(AtenWindow& parent, TMenuButton* buttonParent);
