...
#ifndef ATEN_BUILDTRANSMUTEPOPUP_H
#define ATEN_BUILDTRANSMUTEPOPUP_H

#include "gui/ui_popupbuildtransmute.h"
...
class TransmutePopup : public TPopupWidget
{
