...
#ifndef ATEN_BUILDCLEARPOPUP_H
#define ATEN_BUILDCLEARPOPUP_H

#include "gui/ui_popupbuildclear.h"
...
// Popup Widget - Rebond
class ClearPopup : public TMenuButtonPopupWidget
{
	...
	ClearPopup(AtenWindow& parent, TMenuButton* buttonParent);
