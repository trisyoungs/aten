...
// Constructor
MeasureAnglePopup::MeasureAnglePopup(AtenWindow& parent, TMenuButton* buttonParent) : TPopupWidget(buttonParent), parent_(parent)
{
	// Set up interface
	ui.setupUi(this);
}
...
bool MeasureAnglePopup::callMethod(QString methodName, ReturnValue& rv)
{
	bool result = true;
