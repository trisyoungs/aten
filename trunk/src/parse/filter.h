...
// Filter Types
enum filter_type { FT_MODEL_IMPORT, FT_TRAJECTORY_IMPORT, FT_EXPRESSION_IMPORT, FT_GRID_IMPORT, FT_MODEL_EXPORT,  FT_TRAJECTORY_EXPORT, FT_EXPRESSION_EXPORT, FT_GRID_EXPORT, FT_NITEMS };
