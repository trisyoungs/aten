...
CommandData Command::data[Command::nCommands] = {
	...
	{ "scalevisible",	"NB",		"int scaleid, true|false", VTypes::NoData,
	...
	{ "selectmiller",	"NNNn",		"<h, <k, <l, [inside?]", VTypes::NoData,
	...
	{ "selectoutsidecell",	"b",		"[molecule COG?]", VTypes::IntegerData,
	...
	{ "setview",		"NNNNNNNNNNNNn",VTypes::NoData,
		"<ax, <ay, <az, <bx, <by, <bz, <cx, <cy, <cz, <camx, <camyu, <camz, [zrot]",
