...
CommandData Command::data[Command::nCommands] = {
	...
	{ "angles",		"",		VTypes::NoData,
		"",
		"Measure and print bond angles between atoms in current selection" },
	{ "clearmeasurements",	"",		VTypes::NoData,
		"",
		"Clear all measurements in the current model" },
	{ "distance",		"AAb",		VTypes::DoubleData,
		"atom|int id1, atom|int id2, bool quiet = FALSE",
		"Measure, return, and print (unless quiet) distance between atoms specified" },
	{ "distances",		"",		VTypes::NoData,
		"",
		"Measure and print bond distances between atoms in current selection" },
	...
	{ "torsions",		"",		VTypes::NoData,
		"",
		"Measure and print torsion angles between atoms in current selection" },
	...
	{ "loadmodel",		"Cc^m",		VTypes::IntegerData,
		"string filename, string name = <automatic>, model &newcurrent",
		"Load a model from filename specified, optionally setting new name and retrieving new model pointer" },
