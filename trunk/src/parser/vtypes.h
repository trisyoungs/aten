...
class VTypes
{
	public:
	// Data Types
	enum DataType { NoData, IntegerData, DoubleData, StringData, VectorData, AtenData, AtomData, BasisFunctionData, BondData, CellData, EigenvectorData, ElementData, ForcefieldData, ForcefieldAtomData, ForcefieldBoundData, GlyphData, GlyphDataData, GridData, MeasurementData, ModelData, PatternData, PatternBoundData, PreferencesData, RegionData, ZMatrixData, ZMatrixElementData, nDataTypes };
