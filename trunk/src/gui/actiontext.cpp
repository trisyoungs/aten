...
UserActionText UserActionTexts[] = {
	...
	{ "Draw Fragments", "Click to draw free fragments, or attach to existing atoms", "", "", "" },
	{ "Transmute", "Click atoms to transmute into current drawing element", "", "", "" },
	{ "Delete Atoms/Bonds", "Click individual atoms to delete them", "to delete all bonds attached to atom", "", "" },
