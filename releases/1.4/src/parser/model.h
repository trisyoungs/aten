...
class ModelVariable : public PointerVariable
{
	...
	*/
	public:
	// Accessor list
	enum Accessors { Angles, Atoms, Bonds, Celldata, Distances, FFAngles, FFBonds, FFTorsions, FFTypes, FField, Filename, Frame, Frames, Mass, Name, NAngles, NAtoms, NBonds, NDistances, NFFAngles, NFFBonds, NFFTorsions, NFFTypes, NFrames, NPatterns, NSelected, NTorsions, NUnknown, Patterns, Region, Torsions, nAccessors };
	// Function list
