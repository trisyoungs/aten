...
\begin{wrapfigure}[]{l}[0em]{2.2cm} \includegraphics[width=2cm]{images/water} \end{wrapfigure}
...
\begin{wrapfigure}[]{l}[0em]{4.1cm} \includegraphics[width=4cm]{images/propanoic} \end{wrapfigure}
...
\begin{wrapfigure}[]{l}[0em]{3.1cm} \includegraphics[width=3cm]{images/aromatic} \end{wrapfigure}
