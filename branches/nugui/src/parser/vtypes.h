...
class VTypes
{
	public:
	// Data Types
	enum DataType { NoData, IntegerData, DoubleData, StringData, VectorData, AtenData, AtomData, BasisPrimitiveData, BasisShellData, BondData, CellData, ColourScaleData, ColourScalePointData, EigenvectorData, ElementData, EnergyStoreData, ForcefieldData, ForcefieldAtomData, ForcefieldBoundData, GlyphData, GlyphDataData, GridData, MeasurementData, ModelData, PatternData, PatternBoundData, PreferencesData, SiteData, VibrationData, ZMatrixData, ZMatrixElementData, nDataTypes };
