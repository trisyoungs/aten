...
class ModelVariable : public PointerVariable
{
	...
	*/
	...
	// Function list
	enum Functions { AddHydrogen, AngleEnergy, Augment, BondEnergy, Charge, ClearBonds, ClearCharges, ClearSelectedBonds, Copy, Cut, Delete, ElectrostaticEnergy, Expand, Finalise, InterEnergy, IntraEnergy, MoveToEnd, MoveToStart, NewAtom, NewAtomFrac, NewBasisShell, NewBond, NewBondId, NewEigenvector, NewGlyph, NewGrid, NewVibration, Paste, ReBond, ReBondPatterns, ReBondSelection, Redo, ReOrder, SaveBitmap, SelectAll, SelectionAddHydrogen, SelectNone, SelectTree, ShiftDown, ShiftUp, ShowAll, ToAngstroms, TorsionEnergy, Transmute, Undo, VdwEnergy, nFunctions };
