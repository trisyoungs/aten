...
// Variable Types
const char *DataTypeNames[VTypes::nDataTypes] = { "no data", "int", "double", "string", "vector", "aten&", "atom&", "basisprimitive&", "basisshell&", "bond&", "unitcell&", "colourscale&", "colourscalepoint&", "eigenvector&", "element&", "energystore&", "forcefield&", "ffatom&", "ffbound&", "glyph&", "glyphdata&", "grid&", "measurement&", "model&", "pattern&", "bound&", "prefs&", "site&", "vibration&", "zmatrix&", "zmatrixelement&" };
const char *DataTypePhrases[VTypes::nDataTypes] = { "no data", "an integer", "a double", "a string", "a vector", "aten&", "an atom&", "a basisprimitive&", "a basisshell&", "a bond&", "a unitcell&", "a colourscale&", "a colourscalepoint&", "an eigenvector&", "an element&", "an energystore&", "a forcefield&", "a ffatom&", "a ffbound&", "a glyph&", "a glyphdata&", "a grid&", "a measurement&", "a model&", "a pattern&", "a bound&", "some prefs&", "a site", "a vibration&", "a zmatrix", "a zmatrix element" };
...
const char *DataTypeKeywords[VTypes::nDataTypes] = { "_NODATA", "int", "double", "string", "vector", "_ATEN", "atom", "basisprimitive", "basisshell", "bond", "unitcell", "colourscale", "colourscalepoint", "eigenvector", "element", "energystore", "forcefield", "ffatom", "ffbound", "glyph", "_GLYPHDATA", "grid", "measurement", "model", "pattern", "bound", "_PREFS", "site", "vibration", "zmatrix", "zmatrixelement" };
