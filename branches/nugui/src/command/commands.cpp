...
CommandData Command::data[Command::nCommands] = {
	...
	{ "savemovie",		"Cnnnnnn",	VTypes::NoData,
		"string filename, int width = -1, int height = -1, int quality = -1, int firstframe = 1, int lastframe = <last>, int frameskip = 0",
	...
	{ "loadmodel",		"Cc^m",		VTypes::IntegerData,
		"string filename, string name = null, model &newcurrent = null",
