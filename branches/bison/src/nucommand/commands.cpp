...
NuCommandData NuCommand::data[NuCommand::nCommands] = {
	...
	{ "vdwscale",		"n",		"[scale]", NuVTypes::DoubleData,
	...
	// Energy commands
	{ "frameenergy",	"",		"", NuVTypes::DoubleData,
				"Calculate the energy of the current trajectory frame" },
	{ "modelenergy",	"",		"", NuVTypes::DoubleData,
	...
	// Measurements
	{ "angle",		"AAA",		"<atom/id1> <atom/id2> <atom/id3>", NuVTypes::DoubleData,
	...
	{ "distance",		"AA",		"<atom/id1> <atom/id2>", NuVTypes::DoubleData,
	...
	{ "measure",		"AAaa",		"<atom/id1> <atom/id2> [atom/id3] [atom/id4]", NuVTypes::DoubleData,
				"Make a measurement between the specified atoms" },
	{ "torsion",		"AAAA",		"<atom/id1> <atom/id2> <atom/id3> <atom/id4>", NuVTypes::DoubleData,
	...
	{ "readreal",		"n",		"[nbytes=8]", NuVTypes::DoubleData,
				"Read a floating point value from the (binary) input file" },
	{ "readvar",		"C^z*",	"<string> [data1, data2...]", NuVTypes::IntegerData,
				"Parse delimited arguments from a character variable" },
	{ "readvarf",		"CC^z*",	"<string> <formatting string> [data1, data2...]", NuVTypes::IntegerData,
	...
	{ "writeline",		"Z*",		"<data1> [data2...]", NuVTypes::IntegerData,
	...
	{ "writevar",		"^Cz*",		"<variable> [data1, data2...]", NuVTypes::IntegerData,
				"Write a delimited series of arguments to the supplied character variable" },
	{ "writevarf",		"^CCz*",	"<variable> <formatting string> [data1, data2...]", NuVTypes::IntegerData,
	...
	{ "atof",		"C",		"<string>", NuVTypes::DoubleData,
				"Convert supplied string to floating point number" },
	{ "atoi",		"C",		"<string>", NuVTypes::IntegerData,
	...
	{ "ftoa",		"C",		"<number>", NuVTypes::StringData,
				"Convert supplied real value to a string" },
	{ "itoa",		"C",		"<number>", NuVTypes::StringData,
				"Convert supplied integer to a string" },
	{ "normalise",		"U",		"<vector>", NuVTypes::DoubleData,
