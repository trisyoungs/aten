...
CommandData Command::data[Command::nCommands] = {
	...
	{ "anglelabel",		"c",		"[text]", VTypes::StringData,
				"Set the units label to use for angles" },
	{ "atomdetail",		"n",		"[n]", VTypes::IntegerData,
				"Set the quadric detail of atoms" },
	{ "bonddetail",		"n",		"[n]", VTypes::IntegerData,
				"Set the quadric detail of bonds" },
	{ "cachelimit",		"n",		"[kbytes]", VTypes::IntegerData,
	...
	{ "distancelabel",	"c",		"[text]", VTypes::StringData,
				"Set the units label to use for distances" },
	{ "ecut",		"n",		"[cutoff]", VTypes::DoubleData,
	...
	{ "hdistance",		"n",		"[distance[", VTypes::DoubleData,
				"Set (or get) the H-X bond distance to use when adding hydrogen" },
	{ "intra",		"b",		"[on|off]", VTypes::IntegerData,
				"Turn on/off energy and force calculation of intramolecular terms" },
	{ "key",		"Cc",		"ctrl|shift|alt [action]", VTypes::StringData,
				"Set the action of modifier keys" },
	{ "labelsize",		"n",		"[pointsize]", VTypes::IntegerData,
				"Set the integer pointsize for label text" },
	{ "light",		"b",		"[on|off]", VTypes::IntegerData,
	...
	{ "mouse",		"Cc",		"left|middle|right|wheel [action]", VTypes::StringData,
				"Set the action of mouse buttons" },
	{ "radius",		"Cn",		"<style> [r]", VTypes::DoubleData,
				"Set the general atom scales for view styles" },
	{ "replicatefold",	"b",		"<on|off>", VTypes::IntegerData,
				"Set whether to fold atoms before cell replicate" },
	{ "replicatetrim",	"b",		"<on|off>", VTypes::IntegerData,
				"Set whether to trim atoms after cell replicate" },
	{ "scheme",		"c",		"[colour scheme]", VTypes::StringData,
				"Show (or set) the atomic colouring scheme to use" },
	{ "shininess",		"n",		"<n>", VTypes::IntegerData,
	...
	{ "style",		"c",		"[style]", VTypes::StringData,
				"Set (or show) the current model drawing style" },
	{ "swapbuffers",	"b",		"[on|off]", VTypes::IntegerData,
				"Set (or show) the current model drawing style" },
	{ "usenicetext",	"b",		"[on|off]", VTypes::IntegerData,
				"Use QPainter (on) or QGlWidget (off) to render label text" },
	{ "vcut",		"n",		"<cutoff>", VTypes::DoubleData,
				"Set the VDW cutoff distance" },
	{ "vdw",		"b",		"<on|off>", VTypes::IntegerData,
				"Turn on/off VDW energy/force calculation" },
	{ "zoomthrottle",	"n",		"[ratio]", VTypes::DoubleData,
