...
NuCommandData NuCommand::data[NuCommand::nFunctions] = {
	...
	{ "geometry",		"NEEENNNnn",	"<name> <min> <binwidth> <nbins> <filename> <site1> <site2> [site3 [site4]]", NuVTypes::NoData,
				"Calculate geometries" },
	{ "modelanalyse",	"",		"", NuVTypes::NoData,
				"Analyse quantities for the current model" },
	{ "pdens",		"NEENNN",	"<name> <griddelta> <nsteps> <filename> <site1> <site2> ", NuVTypes::NoData,
	...
	{ "rdf",		"NEEENNN",	"<name> <rmin> <binwidth> <nbins> <filename> <site1> <site2>", NuVTypes::NoData,
	...
	{ "bondtolerance",	"E",		"<tolerance>", NuVTypes::NoData,
	...
	{ "newbond",		"EEn",		"<atom1> <atom2> [bondtype]", NuVTypes::NoData,
				"Create a bond between specified atoms" },
	{ "newbondid",		"EEn",		"<id1> <id2> [bondtype]", NuVTypes::NoData,
