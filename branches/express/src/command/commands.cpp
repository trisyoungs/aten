...
CommandData CA_data[CA_NITEMS] = {
	...
	// Forcefield commands
	{ "angledef",		"VVVVVvvvvv", "<form> <name1> <name2> <name3> <data1> [data2 ... data6]",
				"Add an angle definition to the current forcefield." },
	{ "bonddef",		"VVVVvvvvv", "<form> <name1> <name2> <data1> [data2 ... data6]",
	...
	{ "genconvert",		"VL",		"<data1> [data2..data10]",
				"Set energetic generator data to convert" },
	{ "generator",		"VVvvvvvvvvvv",	"<typeId> <name> <data1> [data2...data10]",
	...
	{ "torsiondef",		"VVVVVVVVvvvvv", "<form> <name1> <name2> <name3> <name4> <escale> <vscale> <data1> [data2 ... data6]",
				"Add a torsion definition to the current forcefield." },
	{ "typedef",		"VVVVv", "<typeid> <name> <element> <type> [description]",
	...
	{ "vdwdef",		"VVVVVvvvvv", "<form> <typeid> <name> <element> <type> [description]",
	...
	{ "replicatefold",	"V",		"on|off",
				"Set whether to fold atoms before cell replicate" },
	{ "replicatetrim",	"V",		"on|off",
				"Set whether to trim atoms after cell replicate" },
	{ "scheme",		"V",		"<colour scheme>",
				"Set the atomic colouring scheme to use." },
	{ "shininess",		"V",		"<n>",
