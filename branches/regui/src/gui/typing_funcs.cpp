...
// Constructor
AtenTyping::AtenTyping(QWidget *parent)
{
	typelistElement_ = -1;
}

// Destructor
AtenTyping::~AtenTyping()
{
}

// Update the list of loaded forcefields
void AtenTyping::refresh()
{
	// If the cell page is not visible, don't do anything
	if (!ui.ShowForcefieldsPageButton->isChecked())
	{
		dbgEnd(Debug::Calls,"AtenTyping::refreshForcefieldPage");
		return;
	}
...
void AtenTyping::refreshForcefieldTypeList()
{
...
void AtenTyping::on_ForcefieldList_currentRowChanged(int row)
{
...
void AtenTyping::on_ForcefieldList_itemClicked(QListWidgetItem *item)
{
...
// Load forcefield 
void AtenTyping::on_LoadForcefieldButton_clicked(bool checked)
{
	QString filename;
...
void AtenTyping::on_RemoveForcefieldButton_clicked(bool checked)
{
...
void AtenTyping::on_EditForcefieldButton_clicked(bool checked)
{
...
void AtenTyping::on_TypeModelButton_clicked(bool checked)
{
	if (master.currentModel()->typeAll()) gui.modelChanged();
}

// Remove typing from model
void AtenTyping::on_UntypeModelButton_clicked(bool checked)
{
...
void AtenTyping::on_ManualTypeSetButton_clicked(bool checked)
{
...
void AtenTyping::on_ManualTypeClearButton_clicked(bool checked)
{
...
void AtenTyping::on_ManualTypeTestButton_clicked(bool checked)
{
	Forcefield *ff = master.currentForcefield();
	int row = ui.FFTypeTable->currentRow();
	if (row == -1) return;
...
void AtenTyping::on_ManualTypeEdit_returnPressed()
{
