...
int command_functions::function_CA_FRAMEFORCES(command *&c, objects &obj)
{
...
int command_functions::function_CA_MODELFORCES(command *&c, objects &obj)
{
...
int command_functions::function_CA_PRINTFORCES(command *&c, objects &obj)
{
	obj.m->print_forces();
	return CR_SUCCESS;
}
