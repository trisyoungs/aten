...
// Variable Types
const char *DataTypeNames[VTypes::nDataTypes] = { "no data", "int", "double", "string", "vector", "aten&", "atom&", "basisprimitive&", "basisshell&", "bond&", "unitcell&", "colourscale&", "colourscalepoint&", "eigenvector&", "element&", "energystore&", "forcefield&", "ffatom&", "ffbound&", "glyph&", "glyphdata&", "grid&", "mc&", "measurement&", "model&", "pattern&", "bound&", "prefs&", "site&", "vibration&", "zmatrix&", "zmatrixelement&" };
const char *DataTypePhrases[VTypes::nDataTypes] = { "no data", "an integer", "a double", "a string", "a vector", "aten&", "an atom&", "a basisprimitive&", "a basisshell&", "a bond&", "a unitcell&", "a colourscale&", "a colourscalepoint&", "an eigenvector&", "an element&", "an energystore&", "a forcefield&", "a ffatom&", "a ffbound&", "a glyph&", "a glyphdata&", "a grid&", "mc&", "a measurement&", "a model&", "a pattern&", "a bound&", "some prefs&", "a site", "a vibration&", "a zmatrix", "a zmatrix element" };
const char *DataTypeArrayPhrases[VTypes::nDataTypes] = { "no data", "an integer array", "a double array", "a string array", "a vector array", "an aten& array", "an atom& array", "a basisprimitive& array", "a basisshell& array", "a bond& array", "a unitcell& array", "a colourscale& array", "a colourscalepoint& array", "an eigenvector& array", "an element& array", "an energystore& array", "a forcefield& array", "a ffatom& array", "a ffbound& array", "a glyph& array", "a glyphdata& array", "a grid& array", "a mc& array", "a measurement& array", "a model& array", "a pattern& array", "a bound& array", "a prefs& array", "a site& array", "a vibration& array", "a zmatrix& array", "a zmatrixelement& array" };
const char *DataTypeKeywords[VTypes::nDataTypes] = { "_NODATA", "int", "double", "string", "vector", "_ATEN", "atom", "basisprimitive", "basisshell", "bond", "unitcell", "colourscale", "colourscalepoint", "eigenvector", "element", "energystore", "forcefield", "ffatom", "ffbound", "glyph", "_GLYPHDATA", "grid", "_MC", "measurement", "model", "pattern", "bound", "_PREFS", "site", "vibration", "zmatrix", "zmatrixelement" };
