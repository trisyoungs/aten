...
class WidgetVariable : public PointerVariable
{
	...
	*/
	...
	// Function list
	enum Functions { AddButton, AddCheck, AddCombo, AddDoubleSpin, AddEdit, AddFrame, AddGroup, AddIntegerSpin, AddLabel, AddPage, AddRadioButton, AddRadioGroup, AddStack, AddTabs, OnDouble, OnInteger, OnRange, OnString, nFunctions };
