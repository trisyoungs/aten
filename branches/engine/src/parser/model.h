...
class ModelVariable : public PointerVariable
{
	...
	*/
	public:
	// Accessor list
	enum Accessors { Angles, Atoms, Bonds, Celldata, Distances, Eigenvectors, Energy, FFAngles, FFBonds, FFMass, FFTorsions, FFTypes, FField, Filename, Frame, Frames, Glyphs, Id, Mass, Name, NAngles, NAtoms, NBasisCartesians, NBasisShells, NBonds, NDistances, NEigenvectors, NFFAngles, NFFBonds, NFFTorsions, NFFTypes, NFrames, NGlyphs, NPatterns, NRequested, NSelected, NTorsions, NUnknown, NVibrations, Patterns, Region, Selection, Torsions, Vibrations, ZMatrix, nAccessors };
	// Function list
